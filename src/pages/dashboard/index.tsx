      ...
      <main className="relative z-10 flex-1 max-w-6xl w-full mx-auto px-6 py-8 flex flex-col gap-6">
        ...
        <Card className="shadow-md dark:shadow-2xl border border-slate-200 dark:border-white/10">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-sm app-text-muted mb-0">
        ...
        <Row gutter={[20, 20]}>
          <Col xs={24} md={8}>
            <Card className="shadow-lg hover:border-indigo-500/40 transition-all">
              <div className="flex items-center justify-between mb-3">
                <DatabaseOutlined className="text-2xl text-cyan-600 dark:text-cyan-400" />
          ...
          <Col xs={24} md={8}>
            <Card className="shadow-lg hover:border-indigo-500/40 transition-all">
              <div className="flex items-center justify-between mb-3">
                <ApiOutlined className="text-2xl text-emerald-600 dark:text-emerald-400" />
                <Tag icon={<CheckCircleFilled />} color="success" className="mr-0 font-semibold">
                  ONLINE
                </Tag>
              </div>
              <h3 className="text-base font-semibold text-slate-800 dark:text-slate-200 mb-1">Backend REST API</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-0">
                Node.js server active on <code>http://localhost:3011</code>
              </p>
            </Card>
          </Col>
          ...
          <Col xs={24} md={8}>
            <Card className="shadow-lg hover:border-indigo-500/40 transition-all">
              <div className="flex items-center justify-between mb-3">
                <ClockCircleOutlined className="text-2xl text-indigo-600 dark:text-indigo-400" />
                <Tag color="processing" className="mr-0 font-semibold">
                  ACTIVE
                </Tag>
              </div>
              <h3 className="text-base font-semibold text-slate-800 dark:text-slate-200 mb-1">JWT Security Session</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-0">
